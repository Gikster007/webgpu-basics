...
int main()
{
    ...
    static_assert(&instance, "Could not initialize WebGPU!");
    ...
    static_assert(&adapter, "Could not retrieve adapter!");
    printf("Adapter is: %p \n", adapter);
    
    // Instance no longer needed, proceed with cleanup
    ...
    static_assert(&device, "Could not retrieve device!");
    ...
    // Adapter not needed anymore, proceed with cleanup
